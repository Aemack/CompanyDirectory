...
CREATE DATABASE IF NOT EXISTS `id14680606_companydirectory` /*!40100 DEFAULT CHARACTER SET utf8 */;
USE `id14680606_companydirectory`;
...
-- Dumping data for table id14686068_companydirectory.department: ~12 rows (approximately)
...
-- Dumping structure for table id14686068_companydirectory.location
...
-- Dumping data for table id14686068_companydirectory.location: ~4 rows (approximately)
...
-- Dumping structure for table id14686068_companydirectory.personnel
...
-- Dumping data for table id14686068_companydirectory.personnel: ~100 rows (approximately)
